...
An **unofficial PyTorch implementation** of "[Autoregressive Speech Synthesis without Vector Quantization](https://arxiv.org/abs/2209.12888)" paper. This repository provides a complete pipeline for training and inference of the MELLE (Mel-spectrogram Language modEL) model.
## 🚀 Quick Start
